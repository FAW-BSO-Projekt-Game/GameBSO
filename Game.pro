...
unrealRootPath=/home/tibo/UnrealEngine
GameRootPath=/home/tibo/Dokumente/GitHub/Game

gameProjectFile=/home/tibo/Dokumente/GitHub/Game/Game.uproject
...
include(GameSource.pri)
include(GameHeader.pri)
include(GameConfig.pri)
include(GameIncludes.pri)
include(GameDefines.pri)

Game-Linux-Debug.commands = $$build Game Linux Debug  -project="\"$$gameProjectFile\"" $$args
Game-Linux-DebugGame.commands = $$build Game Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Game-Linux-Shipping.commands = $$build Game Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Game-Linux-Test.commands = $$build Game Linux Test  -project="\"$$gameProjectFile\"" $$args
Game.commands = $$build Game Linux Development  -project="\"$$gameProjectFile\"" $$args

GameEditor-Linux-Debug.commands = $$build GameEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
GameEditor-Linux-DebugGame.commands = $$build GameEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
GameEditor-Linux-Shipping.commands = $$build GameEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
GameEditor-Linux-Test.commands = $$build GameEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
GameEditor.commands = $$build GameEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Game-Linux-Test \
	Game \
	GameEditor-Linux-Debug \
	GameEditor-Linux-DebugGame \
	GameEditor-Linux-Shipping \
	GameEditor-Linux-Test \
	GameEditor \
