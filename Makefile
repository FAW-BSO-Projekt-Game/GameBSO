...
Game-Linux-Debug:
	 $(PROJECTBUILD) Game Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game-Linux-DebugGame:
	 $(PROJECTBUILD) Game Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game-Linux-Shipping:
	 $(PROJECTBUILD) Game Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game-Linux-Test:
	 $(PROJECTBUILD) Game Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game:
	 $(PROJECTBUILD) Game Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

GameEditor-Linux-Debug:
	 $(PROJECTBUILD) GameEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

GameEditor-Linux-DebugGame:
	 $(PROJECTBUILD) GameEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

GameEditor-Linux-Shipping:
	 $(PROJECTBUILD) GameEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

GameEditor-Linux-Test:
	 $(PROJECTBUILD) GameEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

GameEditor:
	 $(PROJECTBUILD) GameEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
